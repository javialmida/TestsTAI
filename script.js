...
function finalizarTest() {
    ...
    // SOLUCIÓN VISUAL: Solo 3 cápsulas, clases correctas y contenedor grid
    ...
    if (fallosODudas.length > 0) {
        ...
        fallosODudas.forEach((r, idx) => {
            ...
            // Borde naranja si es duda acertada, rojo si es fallo
            ...
            item.innerHTML = `
                <p style="margin-bottom: 10px;"><strong>${idx + 1}. ${r.pregunta}</strong></p>
                <p style="color: #dc3545; margin: 5px 0;">Tu respuesta: ${r.seleccionada.toUpperCase()} - ${r.opciones[r.seleccionada]}</p>
