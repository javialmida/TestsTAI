...
const app = {
    ...
    init: async () => {
        ...
        try {
            ...
            // USAMOS LA NUEVA FUNCIÓN AQUÍ 👇 (botón info)
...
// Función auxiliar para generar el HTML del botón (Normal o Dividido)
// Función auxiliar para generar el HTML del botón (Normal o Dividido)
function renderTestButton(t, isHecho) {
    ...
    // CASO 1: TIENE INFO -> Usamos el diseño DIVIDIDO
    if (t.info) {
        // SOLUCIÓN AL ERROR: Solo escapamos las comillas dobles para que no rompan el HTML.
        // El resto del texto se guarda tal cual en un atributo data-msg.
    ...
    // CASO 2: NO TIENE INFO -> Diseño original
    return `
